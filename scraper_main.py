...
def main():
    parser = argparse.ArgumentParser(description="Zonaprop Hunter - Oportunidades & Market Intelligence en CABA")
    ...
    # 2. Evaluar y rankear oportunidades
    print("\n[Evaluador] Analizando y calculando scores de oportunidad...")
    ...
    # 5. Generar Reporte HTML (tanto en output/ como en index.html para Vercel)
    ...
    # Copiar a index.html en raíz para compatibilidad con Vercel
    try:
    ...
    print("=" * 68)
    print(f" ✅ Total avisos analizados:        {len(raw_properties)}")
